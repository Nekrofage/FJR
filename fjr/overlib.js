...
////////
var olLoaded = 0;var pmStart = 10000000; var pmUpper = 10001000; var pmCount = pmStart+1;
var pmt=''; var pms = new Array(); var olInfo = new Info('4.21', 1);
...
o3_hauto=ol_hauto;
o3_vauto=ol_vauto;
o3_closeclick=ol_closeclick; o3_wrap=ol_wrap; o3_followmouse=ol_followmouse;
...
layerhtml = runHook('ol_content_background', FALTERNATE, o3_css, o3_text,
...
over.onmouseover = function () {hoveringSwitch = true; if (o3_timerid > 0) {
...
if(window.removeEventListener && e.eventPhase == 3) window.removeEventListener("load",OLonLoad_handler,false); else if(window.detachEvent) { // and for IE and Opera 4.x but execute calls to overlib, nd, or cClick()
...
if (endWrap) return (hasDims&&!olNs4) ? (isClose ? '' : '') : '';
else {
...
placeX = o3_x-o3_offsetx-parsedWidth; if (placeX < winoffset) placeX = winoffset;
}
...
registerHook("ol_content_caption", ol_content_caption, FALTERNATE, CSSCLASS); registerHook("ol_content_background", ol_content_background, FALTERNATE, CSSCLASS);
